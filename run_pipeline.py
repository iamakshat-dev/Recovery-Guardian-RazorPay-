...
one transaction can travel end to end — event -> features -> placeholder
classifier -> placeholder policy -> audit record -> SQLite — without any
CSV- or Razorpay-specific logic leaking into the pipeline itself.
